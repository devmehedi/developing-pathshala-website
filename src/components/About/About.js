...
const About = () => {
    return (
        <div>
            <div className='about'>
                <div>
                    <h2>Dedicated To Your Online Success.</h2>
                    <p>
            ...
            <div className='dedication'>
                <div>
                    <Card>
                        <Card.Body>
                            <Card.Title className='text'>Client-Centric Approach</Card.Title>
                            <Card.Text>
                ...
                <div>
                    <Card>
                        <Card.Body>
                            <Card.Title className='text'>Effective Collaboration</Card.Title>
                            <Card.Text>
                ...
                <div>
                    <Card>
                        <Card.Body>
                            <Card.Title className='text'>Quality Delivered In Time</Card.Title>
                            <Card.Text>
